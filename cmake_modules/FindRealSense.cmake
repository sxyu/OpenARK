...
find_path(REALSENSE_INCLUDE_DIRS
    ...
    PATHS ${ARK_DEPENDENCY_DIR}/include $ENV{REALSENSE_ROOT_DIR}/include ${REALSENSE_ROOT_DIR}/include
)

if(CMAKE_CL_64)
    find_library(REALSENSE_LIBRARY
        NAMES realsense
        PATHS ${ARK_DEPENDENCY_DIR}/lib $ENV{REALSENSE_ROOT_DIR}/bin $ENV{REALSENSE_ROOT_DIR}/Release $ENV{REALSENSE_ROOT_DIR}/bin/x64
              ${REALSENSE_ROOT_DIR}/bin ${REALSENSE_ROOT_DIR}/Release ${REALSENSE_ROOT_DIR}/bin/x64
        PATH_SUFFIXES lib lib64
    )
else()
    find_library(REALSENSE_LIBRARY
        NAMES realsense
        PATHS ${ARK_DEPENDENCY_DIR}/lib $ENV{REALSENSE_ROOT_DIR}/bin $ENV{REALSENSE_ROOT_DIR}/Release $ENV{REALSENSE_ROOT_DIR}/bin/Win32
              ${REALSENSE_ROOT_DIR}/bin ${REALSENSE_ROOT_DIR}/Release ${REALSENSE_ROOT_DIR}/bin/Win32
        PATH_SUFFIXES lib
    )
endif()
